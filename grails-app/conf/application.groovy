...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'grails_bihar_22_23.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'grails_bihar_22_23.UserRole'
grails.plugin.springsecurity.authority.className = 'grails_bihar_22_23.Role'
